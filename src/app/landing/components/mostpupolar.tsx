    ...
    return(
        <section className="col-span-2">
            <div className="px-4 py-2 rounded-lg flex items-center justify-center bg-(--foreground)">
                <h2 className="font-bold text-white text-lg lg:text-xl xl:text-2xl">Most Popular</h2>
            </div>
            <div className="flex flex-col gap-4 my-3">
                {Items.map((item, index) => (
                    <div
                    key={index}
                    className="grid grid-cols-5 md:grid-cols-3 lg:grid-cols-5 shadow-md shadow-gray-400 rounded-md p-3 md:p-6 hover:scale-103 transition-transform duration-300 ease-in-out">
