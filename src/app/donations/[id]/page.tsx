              ...
              <div className="space-y-4">
                {similarDonations.map((item) => (
                  <Link
                    ...
                    className="flex gap-3 hover:bg-gray-50 p-2 rounded-md -mx-2"
                  >
...
const donations = [
  {
    ...
    description:
      "High-quality organic rice seeds suitable for lowland farming. These seeds are from the last harvest and have excellent germination rates. Approximately 5kg of seeds available, enough to plant about 1000 square meters.",
    category: "Seeds",
    ...
    donor: "Maria Santos",
    age: "Fresh from last harvest",
    brand: "Local Variety (NSIC Rc222)",
    dimensions: "Approximately 5kg",
    weight: "5kg",
    pickupLocation: "San Pablo City, Laguna",
    pickupAvailability: "Weekdays 8am-5pm, weekends by appointment",
    pickupNotes:
      "Please bring your own containers for the seeds. I can provide information on planting techniques if needed.",
  },
  {
    id: "2",
    title: "Garden Tiller",
