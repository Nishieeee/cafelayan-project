...
export default function BrandDashboard() {
  ...
  const topOrganizations = [
    { name: "Kids Who farm", donations: 3245, city: "Zamboanga City", partnership: "Official" },
  ...
  const cityData = [
    { city: "Metro Manila", scans: 12450, donations: 4200, percentage: 43 },
    { city: "Cebu City", scans: 5670, donations: 1890, percentage: 20 },
    { city: "Davao City", scans: 4230, donations: 1420, percentage: 15 },
    { city: "Iloilo City", scans: 2890, donations: 980, percentage: 10 },
    { city: "Baguio City", scans: 2340, donations: 780, percentage: 8 },
    { city: "Others", scans: 1365, donations: 564, percentage: 4 },
  ]

  const productTypes = [
    { name: "Lettuce Chips Package", value: 8500, color: "#0088FE" },
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-700">2.3 tons</div>
                    <div className="text-sm text-gray-600">Plastic diverted from landfills</div>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-700">15,400</div>
                    <div className="text-sm text-gray-600">Bottles recycled</div>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-700">890 kg</div>
            ...
            <Card className="border-gray-500/50">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <Button onClick={() => setShowPartnershipDialog(true)} className="bg-green-700 text-white hover:bg-green-800">
