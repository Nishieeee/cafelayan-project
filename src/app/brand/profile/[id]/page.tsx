...
export default function BrandProfilePage() {
  ...
  useEffect(() => {
    // Simulate API call
    const brandInfo = brandData[brandId as keyof typeof brandData]
    if (brandInfo) {
      setBrand(brandInfo)
    }
  }, [brandId])
            ...
            <CardContent className="pt-16 pb-6 text-center">
              ...
              <div className="text-left">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {brand.products.slice(0, 4).map((product: any) => (
              ...
              <div className="text-left mt-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {brand.achievements.map((achievement: any, index: number) => (
                    <Card
                      key={index}
                          ...
                          <div className="aspect-square bg-gray-100 relative">
                            ...
                            <div className="absolute inset-0 bg-black/0 hover:bg-black/20 transition-colors flex items-center justify-center">
                              <div className="opacity-0 hover:opacity-100 transition-opacity text-white text-center">
                                ...
                                <div className="text-sm font-medium">{product.scans} scans</div>
                              </div>
                            </div>
                          </div>
                          <CardContent className="p-4">
