...
export default function BrandDashboardPage() {
  ...
  useEffect(() => {
    // Simulate API call
    const data = brandDashboardData[brandId as keyof typeof brandDashboardData]
    if (data) {
      setBrandData(data)
    }
  }, [brandId])
        ...
        <Tabs defaultValue="overview" className="space-y-6">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {brandData.productTypes.map((entry: any, index: number) => (
          ...
          <TabsContent value="organizations" className="space-y-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {brandData.topOrganizations.map((org: any, index: number) => (
                ...
                <CardContent>
                  <div className="space-y-3">
                    {brandData.topOrganizations
                      .filter((org: any) => org.partnership === "Official")
