...
export default function BrandProductsPage() {
  ...
  useEffect(() => {
    // Simulate API call
    const data = brandProductsData[brandId as keyof typeof brandProductsData]
    if (data) {
      setBrandData(data)
    }
  }, [brandId])
  ...
  const filteredProducts = brandData.products.filter((product: any) => {
    const matchesSearch =
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {brandData.products.filter((p: any) => p.status === "Active").length} active
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {brandData.products.reduce((sum: number, p: any) => sum + p.totalScans, 0).toLocaleString()}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {brandData.products.reduce((sum: number, p: any) => sum + p.totalDonations, 0).toLocaleString()}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(
                  brandData.products
                    .filter((p: any) => p.totalScans > 0)
                    .reduce((sum: number, p: any) => sum + p.conversionRate, 0) /
                  brandData.products.filter((p: any) => p.totalScans > 0).length
                ).toFixed(1)}
                %
              </div>
              ...
              <div className="flex gap-4">
                ...
                <Select value={materialFilter} onValueChange={setMaterialFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Biodegradable Plastic">Biodegradable Plastic</SelectItem>
                    <SelectItem value="Bamboo Fiber">Bamboo Fiber</SelectItem>
                    <SelectItem value="Corn Starch">Corn Starch</SelectItem>
                    <SelectItem value="Hemp Fiber">Hemp Fiber</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
