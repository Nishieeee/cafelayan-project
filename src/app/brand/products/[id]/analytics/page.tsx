...
export default function ProductAnalyticsPage() {
  ...
  const analyticsData = {
    ...
    dailyScans: [
      { date: "2025-01-01", scans: 45, donations: 20 },
      { date: "2025-01-02", scans: 52, donations: 23 },
      { date: "2025-01-03", scans: 38, donations: 17 },
      { date: "2025-01-04", scans: 61, donations: 27 },
      { date: "2025-01-05", scans: 49, donations: 22 },
      { date: "2025-01-06", scans: 73, donations: 32 },
      { date: "2025-01-07", scans: 67, donations: 30 },
      { date: "2025-01-08", scans: 55, donations: 24 },
      { date: "2025-01-09", scans: 82, donations: 36 },
      { date: "2025-01-10", scans: 71, donations: 31 },
    ],
    hourlyDistribution: [
      { hour: "00", scans: 12 },
      { hour: "01", scans: 8 },
