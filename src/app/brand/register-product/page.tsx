                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value} >
                              ...
                              <SelectContent className="bg-white">
                                <SelectItem value="Beverages" className="hover:bg-green-200">Beverages</SelectItem>
                                <SelectItem value="Food" className="hover:bg-green-200">Food</SelectItem>
                                <SelectItem value="Personal Care" className="hover:bg-green-200">Personal Care</SelectItem>
                                <SelectItem value="Household " className="hover:bg-green-200">Household</SelectItem>
                                <SelectItem value="Electronics" className="hover:bg-green-200">Electronics</SelectItem>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent className="bg-white">
                                <SelectItem value="PET Plastic" className="hover:bg-green-200">PET Plastic</SelectItem>
                                <SelectItem value="HDPE Plastic" className="hover:bg-green-200">HDPE Plastic</SelectItem>
                                <SelectItem value="PP Plastic" className="hover:bg-green-200">PP Plastic</SelectItem>
                                ...
                                <SelectItem value="Glass" className="hover:bg-green-200">Glass</SelectItem>
                                <SelectItem value="Aluminum" className="hover:bg-green-200">Aluminum</SelectItem>
                                <SelectItem value="Tetra Pak" className="hover:bg-green-200">Tetra Pak</SelectItem>
                                <SelectItem value="Mixed Materials" className="hover:bg-green-200">Mixed Materials</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent className="bg-white">
                              <SelectItem value="Highly Recyclable" className="hover:bg-green-200">Highly Recyclable</SelectItem>
                              <SelectItem value="Recyclable" className="hover:bg-green-200">Recyclable</SelectItem>
                              <SelectItem value="Limited Recyclability" className="hover:bg-green-200">Limited Recyclability</SelectItem>
                              <SelectItem value="Not Recyclable" className="hover:bg-green-200">Not Recyclable</SelectItem>
                              <SelectItem value="Compostable" className="hover:bg-green-200">Compostable</SelectItem>
                              <SelectItem value="Biodegradable" className="hover:bg-green-200">Biodegradable</SelectItem>
                            </SelectContent>
                          </Select>
