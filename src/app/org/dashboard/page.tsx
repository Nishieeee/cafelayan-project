      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          <Card className="hover:bg-green-700 hover:text-white transition-color duration-300 ease">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{organizationData.totalDonations.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">+{organizationData.monthlyGrowth}% from last month</p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:bg-green-700 hover:text-white transition-color duration-300 ease">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{organizationData.totalDonors}</div>
          ...
          <Card className="hover:bg-green-700 hover:text-white transition-color duration-300 ease">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{organizationData.activeCities}</div>
              <p className="text-xs text-muted-foreground">Metro Manila area</p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:bg-green-700 hover:text-white transition-color duration-300 ease">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{organizationData.processingCapacity}%</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold">{organizationData.processingCapacity}%</span>
                  </div>
                  <Progress value={organizationData.processingCapacity} className="h-3" />
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <p className="text-blue-600 font-medium">Daily Capacity</p>
                      <p className="text-xl font-bold">500 items</p>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <p className="text-green-600 font-medium">Currently Processing</p>
                      <p className="text-xl font-bold">425 items</p>
                    </div>
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                      <p className="text-orange-600 font-medium">Available Capacity</p>
                  ...
                  {topDonors.map((donor, index) => (
                    <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:scale-103  transition-transform duration-300 ease">
                      <div className="flex items-center gap-4 ">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge
                              variant={donor.partnership === "Official" ? "default" : "outline"}
                              className="text-xs"
                            >
                              {donor.partnership}
                            </Badge>
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            ...
                            <div className="flex flex-wrap gap-1">
                              {donor.productTypes.slice(0, 2).map((type, idx) => (
                      ...
                      <div className="text-right">
                        <p className="font-bold text-lg">{donor.donations.toLocaleString()}</p>
                        <div className="flex items-center gap-1 text-sm">
                          <TrendingUp className={`h-3 w-3 ${donor.growth > 0 ? "text-green-500" : "text-red-500"}`} />
                          <span className={donor.growth > 0 ? "text-green-500" : "text-red-500"}>
                            {donor.growth > 0 ? "+" : ""}
                            {donor.growth}%
                          </span>
                        </div>
                  ...
                  {donationsByCity.map((city, index) => (
                    <div key={index} className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          <span className="font-bold">{city.donations.toLocaleString()}</span>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-700">3.2 tons</div>
                    <div className="text-sm text-gray-600">Waste processed</div>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-700">1,200 kg</div>
                    <div className="text-sm text-gray-600">CO2 emissions saved</div>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-700">18,500L</div>
          ...
          <TabsContent value="partnerships" className="space-y-6">
                      ...
                      <div key={index} className="p-4 border rounded-lg space-y-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h4 className="font-medium">{request.brandName}</h4>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <p className="font-medium">{request.expectedVolume}</p>
                          </div>
                          <div>
                        ...
                        <div className="flex gap-2 pt-2">
                          <Button size="sm" className="bg-green-700 hover:bg-green-800 text-white hover:scale-103 transition-transform duration-300 ease">
                            Accept Partnership
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => handleViewDetails(request)} className="hover:scale-103 transition-transform duration-300 ease">
                            View Details
                          </Button>
                          <Button size="sm" variant="outline" className="border-red-600 text-red-600 hover:bg-red-600 hover:text-white hover:scale-103 transition-all duration-300 ease">
                            Decline
                          </Button>
                        </div>
                      </div>
                    ...
                    {topDonors.slice(0, 3).map((donor, index) => (
                      <div key={index} className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="font-bold">{donor.donations.toLocaleString()}</p>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm mb-3">
                          ...
                          <div>
                            ...
                            <p className={`font-medium ${donor.growth > 0 ? "text-green-600" : "text-red-600"}`}>
                              {donor.growth > 0 ? "+" : ""}
                              {donor.growth}%
                            </p>
                          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium mb-3 text-green-700">What We Offer</h4>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Reliable Collection Service</p>
                          <p className="text-sm text-gray-600">Regular pickup schedules and emergency collection</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Detailed Impact Reporting</p>
                          <p className="text-sm text-gray-600">Monthly sustainability reports and analytics</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Certification & Recognition</p>
                          <p className="text-sm text-gray-600">Environmental impact certificates for marketing</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Joint sustainability campaigns and PR</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="font-medium mb-3 text-blue-700">Partnership Requirements</h4>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Minimum Volume Commitment</p>
                          <p className="text-sm text-gray-600">Consistent monthly donation volumes</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Clean, sorted materials ready for processing</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Communication Protocol</p>
                          <p className="text-sm text-gray-600">Regular updates and coordination meetings</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                        <div>
                          <p className="font-medium">Sustainability Commitment</p>
                          <p className="text-sm text-gray-600">Alignment with environmental goals and values</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {recentActivity.map((activity, index) => (
                    <div key={index} className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                      <div className="p-2 rounded-full bg-white">
                        ...
                        {activity.type === "pickup" && <Truck className="h-4 w-4 text-purple-600" />}
                      </div>
                      <div className="flex-grow">
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-medium">
                            {activity.type === "donation" && `New donation from ${activity.donor}`}
                            {activity.type === "processing" && `Processing completed`}
                            {activity.type === "pickup" && `Pickup scheduled with ${activity.donor}`}
                          </h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {[
                      { day: "Monday", pickups: 3, processing: "PET Bottles" },
                      { day: "Tuesday", pickups: 2, processing: "Cardboard" },
                      { day: "Wednesday", pickups: 4, processing: "Mixed Materials" },
